    ...
    <div className="bg-green-200 min-h-screen">
      <div className="container mx-auto p-4">
        ...
        <div className="mt-8 text-center">
          ...
          <div className="mt-4">
            <div>
              <h3 className="text-xl mb-4 font-semibold underline">Total</h3>
            </div>
            ...
            <p className="text-xl font-semibold">Protein: {totalProtein()}g</p>
            <p className="text-xl font-semibold">Carbs: {totalCarbs()}g</p>
            <p className="text-xl font-semibold"> Fat: {totalFat()}g</p>
          </div>
        </div>
      </div>
    </div>
